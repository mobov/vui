...
function (_Vue) {
  ...
  _createClass(MFrame, [{
    ...
    get: function get() {
      ...
      genStaticStyles(styles, "".concat(compName$1, "-header"), 'z-index', headerIndex);
      genStaticStyles(styles, "".concat(compName$1, "-footer"), 'z-index', footerIndex);
      genStaticStyles(styles, "".concat(compName$1, "-left"), 'z-index', leftIndex);
      genStaticStyles(styles, "".concat(compName$1, "-right"), 'z-index', rightIndex);
      return styles;
    }
  }]);
