...
function (_Mixins) {
  ...
  return BaseMixin;
}(vuePropertyDecorator.Mixins(mixColor, mixSize, mixSpace, mixElevation));
...
function (_Mixins) {
  ...
  return MView;
}(vuePropertyDecorator.Mixins(mixColor, mixSpaceMargin, mixSpacePadding, mixSize, mixElevation));
  ...
  _createClass(MAppBar, [{
    ...
    value: function render() {
      ...
      var name = this.name,
          ...
          handleWheel = this.handleWheel; // {$slots.left}
...
function (_Mixins) {
  ...
  _createClass(MAvatar, [{
    ...
    get: function get() {
      ...
      return Object.assign({}, this.baseClass, this.shapeClass, this.varietyClass, _defineProperty({}, "m--status-".concat(Status[status]), true));
    }
  }]);
