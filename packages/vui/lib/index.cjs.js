...
var uid = _interopDefault(require('nanoid'));
...
MIcon = __decorate([vuePropertyDecorator.Component], MIcon);
var MIcon$1 = MIcon;
...
MAppBar = __decorate([vuePropertyDecorator.Component({
...
MAvatar = __decorate([vuePropertyDecorator.Component({
  mixins: [mixColor, mixSize, mixSpace, mixElevation, mixVariety, mixShape]
})], MAvatar);
...
MList = __decorate([vuePropertyDecorator.Component({
  mixins: [mixColor, mixSize, mixSpace, mixShape, mixElevation]
})], MList);
var MList$1 = MList;
...
MListItem = __decorate([vuePropertyDecorator.Component({
  mixins: [mixColor, mixSize, mixSpace, mixShape, mixElevation]
})], MListItem);
...
__decorate([vuePropertyDecorator.Watch('visible'), __metadata("design:type", Function), __metadata("design:paramtypes", [Boolean]), __metadata("design:returntype", void 0)], PopperMixin.prototype, "whenVisibleUpdate", null);
...
function (_Vue) {
  ...
  _createClass(MTooltip, [{
    ...
    value: function beforeCreate() {
      this.popperVM = new vuePropertyDecorator.Vue({
        data: {
          node: ''
        },
...
__decorate([vuePropertyDecorator.Emit('show'), __metadata("design:type", Function), __metadata("design:paramtypes", [MouseEvent]), __metadata("design:returntype", void 0)], MTooltip.prototype, "emitShow", null);

__decorate([vuePropertyDecorator.Emit('hide'), __metadata("design:type", Function), __metadata("design:paramtypes", [MouseEvent]), __metadata("design:returntype", void 0)], MTooltip.prototype, "emitHide", null);

MTooltip = __decorate([vuePropertyDecorator.Component({
